...
fname=$1
field="desi2"
file_dir="${field}_20251118_150000"

# 创建目录（存放本次运行的数据）

OUTPUT_DIR="/scratch3/users/liutianyang/katcali_pipeline/level1/py_results/${file_dir}"
logs_dir="/scratch3/users/liutianyang/katcali_pipeline/level1/logs/${file_dir}"
mkdir -p ${OUTPUT_DIR}
mkdir -p ${logs_dir}
...
#SBATCH --mem=16GB
#SBATCH --time=2:00:00
#SBATCH --error=${logs_dir}/job_${fname}_${ant}.err
#SBATCH --output=${logs_dir}/job_${fname}_${ant}.out
